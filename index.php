        ...
        <div class="boxed">
            ...
            <div class="row text-center footer-ill mx-auto pb-5">
                <div class="col-12 col-md-6 d-flex flex-column align-items-center">
                    ...
                    <p style="line-height: 1.5;">Using our super fast food recognition software, we help you identify meals in seconds and give you a free recipe</p>
                </div>
                <div class="col-12 col-md-6 pt-5 pt-md-0 d-flex flex-column align-items-center">
                    ...
                    <p style="line-height: 1.5;">Unsure what meal to make of the foodstuff available for you? The meal maker feature puts brilliant ideas in mind.</p>
                </div>
            </div>
        </div>
            <div class="coming-soon py-5">
                <p class="mx-auto w-75 w-sm-100 text-center">Coming soon for Android and iOS devices</p>
            </div>
